...
def gen_spec(epsilon, share_max_val, share_init, filename) :
    """
...
share_max_val = 10
share_init = 0
epsilons = [0.1,0.15,0.20, 0.25, 0.30, 0.35, 0.40]
for epsilon in epsilons :
    filename = f"""investor-{epsilon}-{share_max_val}-{share_init}.prism"""
    gen_spec(epsilon, share_max_val, share_init, filename)
